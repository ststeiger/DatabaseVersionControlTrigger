...
namespace DatabaseVersionControl
{
    ...
    internal static class CertificateCallback
    {
        ...
        // Default SSL certificate validation callback
        internal static bool DefaultCertificateValidationCallback(
            object sender,
        ...
        internal static bool SelfSignedCertificateValidationCallBack(
             object sender,
             System.Security.Cryptography.X509Certificates.X509Certificate certificate,
             System.Security.Cryptography.X509Certificates.X509Chain chain,
             System.Net.Security.SslPolicyErrors sslPolicyErrors)
